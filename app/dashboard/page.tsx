        ...
        <div className="bg-white shadow-md border border-gray-200 rounded-xl overflow-hidden">
          <div className="p-8 space-y-8">
            ...
            <section>
              ...
              <textarea
                className="w-full p-4 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all outline-none resize-none"
            ...
            <section>
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-2 hover:border-indigo-400 transition-colors">
            ...
            <div className="pt-4">
              <button
                onClick={runAgents}
                className="w-full flex justify-center py-3 px-4 rounded-lg shadow-sm text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors"
              >
                Run AI Agents
              </button>
            </div>
