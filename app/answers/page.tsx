  ...
  return (
    <div className="bg-white shadow-sm rounded-2xl p-8 border border-gray-200 transition-all hover:shadow-md">
      ...
      <div className="text-gray-700 leading-relaxed">
        ...
        {content ? (
          <div className="markdown-prose break-words max-w-full overflow-x-auto">
      ...
      <style jsx global>{`
        ...
        .markdown-prose table {
          @apply w-full border-collapse mb-4 mt-2 text-sm block overflow-x-auto;
        }

        .markdown-prose th {
          @apply bg-gray-50 border border-gray-200 p-2 text-left font-bold;
        }
